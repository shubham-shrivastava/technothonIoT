![JQVMap](https://jqvmap.com/img/logo.png "JQVMap")

Creating Custom Maps for JQVMaps
===

Special thanks again to [jvectormap](https://jvectormap.com) for creating the base converter for this.  I have flushed out the documentation a little more for any Python newbies out there ( like myself ).
...
2. [GDAL](https://trac.osgeo.org/gdal/wiki/DownloadingGdalBinaries) _( OS Binary )_
...
5. [Booleano](https://code.gustavonarea.net/booleano/index.html) _( Python Package )_
...
Now we need to install the [GDAL/OGR binaries](https://trac.osgeo.org/gdal/wiki/DownloadingGdalBinaries) and follow the steps they layout for your designated OS.

__OSX:__

Download and install the [GDAL 1.11 Complete](https://www.kyngchaos.com/files/software/frameworks/GDAL_Complete-1.11.dmg) Package.

Alternatively, If you have [Homebew](https://brew.sh/) installed, you can run the following, though I personally had issues with it working 100%
...
You should be able to run [Maptools](https://www.maptools.org/ms4w/index.phtml?page=downloads.html) custom [MS4W installer](https://www.maptools.org/dl/ms4w/ms4w-3.0.6-setup.exe) to get everything you need.
